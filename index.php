  ...
  <section class="food_section layout_padding">
    <div class="container">
      ...
      <div class="containr heading_center">
        <ul class="filters_menu  item-grid owl-carousel owl-rtl owl-loaded owl-drag">
        <div class="item" style="align-items:center">
        <li class="active" data-filter="*" >
          <h6 style="padding: 10px 0px 10px 0px;">القائمه كاملة</h6>
          ...
          <li data-filter=".starters">
            <h6 style="padding: 10px 0px 10px 0px;" >المقبلات</h6>
          ...
          <li data-filter=".salads">
            <h6 style="padding: 10px 0px 10px 0px;" >السلطات</h6>
        ...
        width="50px" height="50px" alt=""> -->
          ...
          <li data-filter=".fries">
            <h6 style="padding: 10px 0px 10px 0px;">البطاطس المقلية</h6>
        ...
        width="50px" height="50px" alt=""> -->
          ...
          <li data-filter=".beef-burger">
            <h6 style="padding: 10px 0px 10px 0px;" >بيف برجر</h6>
        ...
        width="50px" height="50px" alt=""> -->
          ...
          <li data-filter=".chicken-burger">
            <h6 style="padding: 10px 0px 10px 0px;">تشيكن برجر</h6>
        ...
        width="50px" height="50px" alt=""> -->
          ...
          <li data-filter=".hot-dog">
            <h6 style="padding: 10px 0px 10px 0px;">هوت دوج</h6>
...
<!-- Menu items -->
      <div class="filters-content" dir="rtl">
        <div class="row grid">
...
?>
          ...
          <div style="display: flex;" class="col-sm-6 col-lg-4 all <?php echo $dir; ?>">
            <div class="box">
              <div>
                <div class="img-box">
                  <?php
  ...
  <footer class="footer_section">
    <div class="container">
      <div class="row">
        <div class="col-md-6 footer-col">
          <div class="footer_contact">
            ...
            <div  dir="ltr" lang="en" cite="Romeo and Juliet (II, ii, 1-2)" class="contact_link_box">
              <a href="">
        ...
        <div class="col-md-6 footer-col">
          <div class="footer_detail">
            <a href="" class="footer-logo">
              <span>
                <img src="images/Logo-White-Ar.png" alt="" width="75px;">
              </span>
            </a>
            <p>
            نحن نقدم ما تبحث عنه. بمطعم أليكي متع احساسك بتناغم النكهات عند مزجها مع بعضها البعض.. وتذوق أشهي وأطيب الشطائر، التي تمنحك طعما مميزا ونكهة خاصة لا يقدمها سوي أليكي
            </p>
      ...
      <div  dir="ltr" lang="en" cite="Romeo and Juliet (II, ii, 1-2)" class="footer-info">
        <p>
